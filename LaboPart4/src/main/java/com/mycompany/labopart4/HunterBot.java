package com.mycompany.labopart4;
...
*/
    ...
    public void stateEngage() {
        ...
        log.info("HERE!!!!!!!!!!!0");
        log.info("HERE!!!!!!!!!!!P0*"+runningToPlayer);
        ...
        log.info("HERE!!!!!!!!!!!P1*"+runningToPlayer);
        ...
        if (!enemy.isVisible() /*|| !shooting*/ || decentDistance < distance) {
            log.info("HERE!!!!!!!!!!!2");
            log.info("HERE!!!!!!!!!!!2"+!enemy.isVisible()+" "+!shooting+" "+(decentDistance < distance));
            if (!runningToPlayer) {
                log.info("HERE!!!!!!!!!!!3*"+runningToPlayer);
    ...
    static void test(Object obj) {
        JRef jref = new JRef(obj);
        //Term a = new Term(jref);
        //Variable Y = new Variable("Y") {};

        //Variable U = new Variable("U") {};
        Query q3 = new Query("test", new Term[] {jref});
