...
public class HunterBot extends UT2004BotModuleController<UT2004Bot> {
    ...
    /**
     * {@link PlayerKilled} listener that provides "frag" counting + is 0
...
/* IDEE : Utiliser la technique de l'apprentissage par renforcement sur le bot, pour la choix des armes utilisés lors de la confrontation avec l'enemie.
   Pour ça on se basera sur l'état actuel du bot, la energie du bot, la distance entre bot et enemie et le historique de résultats
   (armes utilisés) des confrontations du passé.
